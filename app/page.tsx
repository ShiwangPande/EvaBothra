...
const ContactForm = dynamic(() => import('@/components/ContactForm').then(mod => mod.default))

export default function HomePage() {
  const [selectedSectionKey, setSelectedSectionKey] = useState<keyof typeof portfolioData | null>(null)
  ...
  const handleImageClick = useCallback((key: keyof typeof portfolioData) => {
  ...
  const toggleViewMode = useCallback(() => {
    setViewMode(current => current === 'overlay' ? 'navigate' : 'overlay')
