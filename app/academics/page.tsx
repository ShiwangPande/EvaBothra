  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white via-blue-50/20 to-white">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 pb-16 space-y-12">
        ...
        {/* Research - Full Width Cards with Images */}
        {sections.research && (
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-gray-900">
              ...
              {sections.research.items.map((item, idx) => (
                ...
                >
                  ...
                  {item.imageSrc && (
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      <Image 
                        src={item.imageSrc} 
                        alt={item.title} 
                        fill 
                  ...
                  <div className="p-5 md:p-6 flex flex-col flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-3 text-sm md:text-base flex-grow">{item.description}</p>
                    ...
                    {item.link && (
                      <a 
                        ...
                        className="inline-flex items-center gap-1.5 text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors duration-200 group/link w-fit"
                      >
