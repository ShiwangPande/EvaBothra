...
export default function AcademicsPage() {
  ...
  // Helper for right-side image card with optional carousel
  function CardWithRightImage({ item, idx }: { item: any; idx: number }) {
    ...
    return (
      ...
      >
        ...
        {images.length > 0 && (
          <div
            className="relative w-full md:w-[55%] h-[380px] md:h-[520px] flex-shrink-0 cursor-pointer group/img flex items-center justify-center"
            tabIndex={0}
            role="button"
